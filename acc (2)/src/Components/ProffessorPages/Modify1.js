...
export default function Modify1(){
   ...
   const Modify1=async(e)=>{
      e.preventDefault()
      try{
        const url = "http://127.0.0.1:5000/Progress1"
        const options = {
          method: "POST",
          headers:{"Content-Type": "application/json"},
          body: JSON.stringify({ 
    ...
    <div>
      ...
      <div className='Main_Modify1'>
         <div className='Main_Modify1_Content'>
            <ul> 
               <br/>
               <h3><strong>Evaluación 1: {student.StudentName}</strong></h3>
               ...
               <Table variant="Modify1_table" className="Modify1_table">
                  ...
                  <tbody>
                     ...
                     <tr>
                        <td><h4>Metodología/Medidas de desempeño</h4></td>
                        <td>
                     ...
                     <tr>
                        <td><h4>Planificación/presentación</h4></td>
                        <td>
                     ...
                     <tr>
                        <td><h4>Proyecto ingenieril</h4></td>
                        <td>
            ...
            <Button variant="success" onClick={Modify1}>Guardar</Button>
         </div>
      </div>   
    </div>
    )
