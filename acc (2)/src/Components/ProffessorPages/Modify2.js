...
export default function Modify2(){
   const navigate = useNavigate(); /*Variable utilizada para redirigir al Modify2 page*/
   ...
   const Modify2=async(e)=>{
      e.preventDefault()
      try{
        const url = "http://127.0.0.1:5000/Progress2"
        const options = {
          method: "POST",
          headers:{"Content-Type": "application/json"},
          body: JSON.stringify({ 
  ...
  return(
   <div>
      ...
      <div className='Main_Modify2'>
         <div className='Main_Modify2_Content'>
            <ul> 
               <br/>
               <h3><strong>Evaluación 2: {student.nombreUsuario}</strong></h3>
               ...
               <br/>
               <Table variant="Modify2_table" classname="Modify2_table">
                  <thead>
                     <tr>
                  ...
                  <tbody>
                     ...
                     <tr>
                        <td><h4>Plan de implementación</h4></td>
                        <td>
                     ...
                     <tr>
                        <td><h4>Análisis de riesgo</h4></td>
                        <td>
                     ...
                     <tr>
                        <td><h4>Resultados esperados</h4></td>
                        <td>
            ...
            <Button variant="success" onClick={Modify2}>Guardar</Button>
         </div>
      </div>   
    </div> 
   )
