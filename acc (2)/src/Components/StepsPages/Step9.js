...
export default function Step9(){
    ...
    const fetchdata = async ()=>{
      try{
        ...
        if (response.status === 200){
          ...
          console.log(responseData.Evaluation2)
          setData(responseData.Evaluation2);
          console.log(responseData.Evaluation2);
          setLoading(false)
  ...
  return(
    ...
    <div className='Top_Step'>
         <Navbar expand="lg" className="Top_Navbar_Step"  fixed="top">
            ...
            <div className='Top_Navbar_div_Step'>
               <Row>
                  <Col><p className="Current_Step">{t("Landing.crntstep")}9</p></Col>
                  <Col>
    ...
    <div className='Main_Step9'>
      <div className='Main_Step9_Text'>
        <h2><strong>{t("Step9.tittle")}</strong></h2>
        ...
        <h3 classname="Step9_text"><strong>{t("Step9.t11")}{data.FinalGrade}</strong></h3>
        <div className='Main_Step9_Buttons'>
        <Row>
            <Col>
              <Dropdown>
                <Dropdown.Toggle  className='Main_Step9_Button1' variant= "primary" size="lg">{t("Step12.t9")}</Dropdown.Toggle >
                <Dropdown.Menu>
                  <Table striped bordered hover>
                    <thead>
                      <tr>
            ...
            <Col>
              <Button className='Main_Step8_Button2' variant="success" size="lg" onClick={HandlerStep9}>{t("Step9.btn")}</Button>
            </Col>
          </Row>
        </div>
      </div>
